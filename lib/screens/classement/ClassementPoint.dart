...
class ClassementPoint extends StatefulWidget {
  @override
  _ClassementPointState createState() => _ClassementPointState();
}

class _ClassementPointState extends State<ClassementPoint> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    listTotal.sort((a,b) => a.pointPositif.toString().compareTo(b.pointPositif.toString()));
